...
import ai.jacc.durableThreads.e2e.ChildJvm;
    ...
    void freezeAtFiveAndRestore() throws Exception {
        ...
        try {
            ...
            ChildJvm.Result freezeResult = ChildJvm.run(
                    "ai.jacc.durableThreads.e2e.helloWorld.HelloFreezeProgram",
            ...
            ChildJvm.Result restoreResult = ChildJvm.run(
                    "ai.jacc.durableThreads.e2e.helloWorld.HelloRestoreProgram",
