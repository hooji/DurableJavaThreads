...
class PerformanceBenchmarkIT {
    ...
    void benchmarkBasicFreezeRestore() throws Exception {
        runBenchmark("basic", "com.u1.durableThreads.e2e.FreezeProgram",
                "com.u1.durableThreads.e2e.RestoreProgram");
    }

    @Test @Order(2)
    void benchmarkDeepCallChain() throws Exception {
        runBenchmark("deep-call-chain", "com.u1.durableThreads.e2e.DeepCallChainFreezeProgram",
                "com.u1.durableThreads.e2e.RestoreProgram");
    }

    @Test @Order(3)
    void benchmarkLoop() throws Exception {
        runBenchmark("loop", "com.u1.durableThreads.e2e.LoopFreezeProgram",
                "com.u1.durableThreads.e2e.RestoreProgram");
    }

    @Test @Order(4)
    void benchmarkHeapObjects() throws Exception {
        runBenchmark("heap-objects", "com.u1.durableThreads.e2e.HeapObjectFreezeProgram",
                "com.u1.durableThreads.e2e.RestoreProgram");
    }

    @Test @Order(5)
    void benchmarkReturnValues() throws Exception {
        runBenchmark("return-values", "com.u1.durableThreads.e2e.ReturnValueFreezeProgram",
                "com.u1.durableThreads.e2e.RestoreProgram");
    }

    @Test @Order(6)
    void benchmarkManyLocals() throws Exception {
        runBenchmark("many-locals", "com.u1.durableThreads.e2e.ManyLocalsFreezeProgram",
                "com.u1.durableThreads.e2e.RestoreProgram");
    }

    @Test @Order(7)
    void benchmarkNestedLoop() throws Exception {
        runBenchmark("nested-loop", "com.u1.durableThreads.e2e.NestedLoopFreezeProgram",
                "com.u1.durableThreads.e2e.RestoreProgram");
    }
